        ...
        <View className="flex flex-row justify-evenly mt-4">
            <View className="flex-row border border-gray-200 dark:border-neutral-900 rounded-3xl gap-6 h-8 items-center">
                <Animated.View
                    ...
                    style={animatedStyle}
                />
                <SwitcherElement name={Timeframe.D} />
                <SwitcherElement name={Timeframe.W} />
                <SwitcherElement name={Timeframe.M} />
                <SwitcherElement name={Timeframe.Y} />
            </View>
        </View>
    );
}

function SwitcherElement({ name }: { name: Timeframe }) {
