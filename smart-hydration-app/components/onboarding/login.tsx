            ...
            <ScrollView className="flex mt-20 gap-10">
                <View className='items-center gap-14'>
                 ...
                 <View className='mx-16 gap-5 mt-16 items-center'>
                    ...
                    {isError && <Text>Incorrect username or password. Please try again</Text>}
                    <Pressable onPress={handleSubmit} className="bg-blue px-4 py-2 rounded-xl mt-10"><Text className="text-2xl font-semibold text-white">Submit</Text></Pressable>
                    <Pressable onPress={()=>setPage('register')} className="bg-blue px-4 py-2 rounded-xl mt-10"><Text className="text-xl font-semibold text-white">Register new account</Text></Pressable>
                </View>
            </ScrollView>
        </PageWrapper>
    )
