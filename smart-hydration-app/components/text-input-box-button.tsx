...
export default function TextInputWithButton ({ name, label, placeholder }: TextInputProperties){
    ...
    return (
        <View className='flex justify-center'>
            <Text className="block mb-4 text-sm font-medium text-gray-900 dark:text-black">{label}</Text>
            <TextInput
            ...
            />
            <View className='py-5'>
                <Pressable className="bg-gray-200 py-1 rounded-2xl flex flex-row justify-center"
                       onPress={()=>{
                        mutate(text);
                        setPopup('none');}}>
