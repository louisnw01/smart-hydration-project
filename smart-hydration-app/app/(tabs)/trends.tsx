...
function getDay(x: number) {
    ...
    return ["Mon", "Tues", "Wed", "Thurs", "Fri", "Sat", "Sun"][norm] || "";
}
                ...
                <View className="flex mx-8 mt-8">
                    ...
                    <View className="flex flex-row justify-evenly mt-4">
                        <View className="bg-gray-200 rounded-3xl">
                            <Text className="text-lg px-4">D</Text>
                        </View>
                        <View className="bg-gray-200 rounded-3xl">
                            <Text className="text-lg px-4">W</Text>
                        </View>
                        <View className="bg-gray-200 rounded-3xl">
                            <Text className="text-lg px-4">M</Text>
                        </View>
                        <View className="bg-gray-200 rounded-3xl">
                            <Text className="text-lg px-4">Y</Text>
                        </View>
                    </View>
